...
description: Writes the single failing test for a fix-it / feature-it slice, given only the seam and the expected behavior — no implementation reasoning. Guarded by skill-guard: cannot write under src/.
